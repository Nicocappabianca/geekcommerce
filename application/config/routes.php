...
$route['admin/products/delete'] = 'admin/products/delete';
$route['admin/products/update_form'] = 'admin/products/update_form';
$route['admin/products/update'] = 'admin/products/update';
$route['admin/products/logout'] = 'admin/products/logout';
